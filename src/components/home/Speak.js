...
function speak(){
    return(
        ...
        <img  className="w-10 mt-9 ml-8 lg:ml-28 lg:mt-16 lg:w-16"src={image}></img>
        </span>
...
Muthiyalpet, Puducherry - 3 </p>
        <img className="w-10 mt-5 ml-8 lg:mt-16 lg:ml-28 lg:w-16" src={image1}></img></span>
        <div className="w-2 h-25 mt-10 mb-5 mr-5 rounded-md bg-linecolor lg:ml-16"></div>
...
">kavinbalaexports<br></br>@gmail.com</a></p>
<img  className="w-10 mt-5  lg:ml-28 ml-8 lg:w-16 lg:mt-8"  src={image2}></img></span>
        </div>

        </div>
        <div className="w-100 ml-1 mt-8 -mb-20 mr-1 h-2 bg-linecolor rounded-md	lg:mt-16 lg:mb-16"></div>
